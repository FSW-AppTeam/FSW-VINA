    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">SurveyAnswers Details</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                
                    <h6 class="text-decoration-underline">Surveyanswers_id</h6>
                        <p class="text-muted">{{$surveyanswers_id}}</p>
                    <hr>
            
                    <h6 class="text-decoration-underline">Student_id</h6>
                        <p class="text-muted">{{$student_id}}</p>
                    <hr>
            
                    <h6 class="text-decoration-underline">Question_id</h6>
                        <p class="text-muted">{{$question_id}}</p>
                    <hr>
                    ...
                    <h6 class="text-decoration-underline">Student_answer</h6>
                        <p class="text-muted">{{$student_answer}}</p>
                    <hr>
