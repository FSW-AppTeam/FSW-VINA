<div class="h-100">
    ...
    @include('livewire.survey.components.delete')
    <!-- View Modal -->
    @include('livewire.survey.components.view')
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <select wire:model.live="orderBy" id="orderBy" class="form-select">
                <option value="survey_id">Survey_id</option><option value="survey_code">Survey_code</option><option value="started_at">Started_at</option><option value="finished_at">Finished_at</option><option value="created_at">Created_at</option><option value="updated_at">Updated_at</option>
            </select>
        </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-sm">
            ...
            <tbody>
            @forelse($paginatedSurveys as $model)
                <tr>
                    <td>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center">No survey found...</td>
                </tr>
            @endforelse
            </tbody>
        </table>
        {{$paginatedSurveys->links()}}
    </div>
</div>
