<div wire:ignore.self class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" id="createModal" tabindex="-1" role="dialog"
     aria-labelledby="createSurveyQuestion" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Create New SurveyQuestion</h5>
            ...
            <div class="form-group">
                ...
                <input wire:model="question_answer_options" type="json" class="form-control" name="question_answer_options"
            ...
            <div class="form-group">
                ...
                <input wire:model="question_options" type="json" class="form-control" name="question_options"
                       id="question_options"
