...
class FormStep28 extends Component
{
    ...
    public function save(): void
    {
        ...
        if (session::has('survey-student-class-id')) {
            ...
            session::put(['student-class-collaborate' => $this->answerSelected]);
    ...
    {
        $this->answerSelected = old('answerSelected') ?? \Session::get('student-class-collaborate') ?? [];
    }

    public function render()
    {
        return view('livewire.forms.form-step28');
    }
}
